...
// void ImageLabel::setBoatSide(int t_x, int t_y, int b_x, int b_y){
//     std::cout << "SET BOAT SIDE IN IMAGE LABEL" << "\n";

//     rightBoat_top = QPoint(t_x,t_y);
//     leftBoat_top = QPoint(Width - rightBoat_top.x(), rightBoat_top.y());
//     rightBoat_bottom = QPoint(b_x,b_y);
//     leftBoat_bottom = QPoint(Width - rightBoat_bottom.x(), rightBoat_bottom.y());
// }
void ImageLabel::setBoatSide(QPoint top, QPoint bot){
    // std::cout << "SET BOAT SIDE IN IMAGE LABEL" << " T " << top.x() << " " << top.y() 
        // << " B " << bot.x() << " " << bot.y();

    rightBoat_top = top;
    leftBoat_top = QPoint(Width - rightBoat_top.x(), rightBoat_top.y());
    rightBoat_bottom = bot;
    leftBoat_bottom = QPoint(Width - rightBoat_bottom.x(), rightBoat_bottom.y());
}
